...
exports.sendBookingConfirmationEmail = exports.sendForgotPasswordEmail = exports.sendPartnerRejectionEmail = exports.sendPartnerApprovalEmail = exports.sendAdminCredentials = exports.sendBookingConfirmationEmailDirect = exports.sendForgotPasswordEmailDirect = exports.sendPartnerRejectionEmailDirect = exports.sendPartnerApprovalEmailDirect = exports.sendAdminCredentialsDirect = void 0;
...
const LOGO_PATH = path_1.default.join(__dirname, "../../public/assets/logo.png");
/**
 * @name sendMail
 * @description
...
const sendMail = (options) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const info = yield transporter.sendMail(Object.assign(Object.assign({ from: `Home Care <${process.env.SMTP_FROM}>` }, options), { attachments: [
                ...(options.attachments || []),
                {
                    filename: "logo.png",
                    path: LOGO_PATH,
        ...
        logger_1.default.debug(`Email sent: ${info.messageId}`);
        return info;
    }
    catch (error) {
 ...
 * @access Private
 */
const sendAdminCredentialsDirect = (email, name, password) => __awaiter(void 0, void 0, void 0, function* () {
    return sendMail({
        to: email,
        ...
        <div style="font-family: Alexandria, sans-serif; line-height: 1.6; color: #444; max-width: 550px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            <img src="cid:logo" alt="HomeCare" width="160" style="display: block; margin: 0 auto; height: 45px;">
          ...
          <p style="font-size: 15px; color: #555; margin-bottom: 25px;">
            Use the following credentials to access your HomeCare admin account. Please make sure to keep these details secure.
          </p>
          ...
          <div style="text-align: center; border-top: 1px solid #ddd; padding-top: 20px; font-size: 12px; color: #999;">
            <p style="margin: 0;">&copy; 2026 HomeCare. All rights reserved.</p>
...
exports.sendAdminCredentialsDirect = sendAdminCredentialsDirect;
/**
 ...
 * @access Private
 */
const sendPartnerApprovalEmailDirect = (email, name, resetLink) => __awaiter(void 0, void 0, void 0, function* () {
    return sendMail({
        to: email,
        ...
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #444; max-width: 550px; margin: 0 auto; padding: 20px;">
          ...
          <p style="font-size: 16px; margin-bottom: 15px;">Hello <strong>${name}</strong>,</p>
          <p style="font-size: 15px; color: #555; margin-bottom: 25px;">
            Congratulations! Your service partner profile has been reviewed and approved by our team. You are now part of the HomeCare partner network.
          </p>
          <p style="font-size: 15px; color: #555; margin-bottom: 25px;">
...
exports.sendPartnerApprovalEmailDirect = sendPartnerApprovalEmailDirect;
/**
 ...
 * @access Private
 */
const sendPartnerRejectionEmailDirect = (email, name) => __awaiter(void 0, void 0, void 0, function* () {
    return sendMail({
        to: email,
...
exports.sendPartnerRejectionEmailDirect = sendPartnerRejectionEmailDirect;
/**
 ...
 * @access Private
 */
const sendForgotPasswordEmailDirect = (email, name, resetLink) => __awaiter(void 0, void 0, void 0, function* () {
    return sendMail({
        to: email,
...
exports.sendForgotPasswordEmailDirect = sendForgotPasswordEmailDirect;
/**
 ...
 * @access Private
 */
const sendBookingConfirmationEmailDirect = (email, name, bookingId, serviceName, slot, amount) => __awaiter(void 0, void 0, void 0, function* () {
    return sendMail({
        to: email,
        ...
        <div style="font-family: Alexandria, sans-serif; line-height: 1.6; color: #444; max-width: 550px; margin: 0 auto; padding: 20px;">
          ...
          <p style="font-size: 16px; margin-bottom: 15px;">Hello <strong>${name}</strong>,</p>
          <p style="font-size: 15px; color: #555; margin-bottom: 25px;">
            Thank you for choosing HomeCare! Your booking has been successfully confirmed. Our service provider will arrive at your location as per the scheduled slot.
          </p>
          ...
          <div style="background-color: #fff9f2; border-left: 4px solid #f5a623; padding: 15px; margin-bottom: 25px;">
            <p style="margin: 0; font-size: 14px; color: #555;">
              You can track your booking status and view more details in the "My Bookings" section of the HomeCare.
            </p>
          </div>
...
exports.sendBookingConfirmationEmailDirect = sendBookingConfirmationEmailDirect;
/**
 * Queued functions (Queued)
 */
const sendAdminCredentials = (email, name, password) => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, email_queue_1.addEmailJob)(email_enum_1.EMAIL_WORKER.SEND_ADMIN_CREDENTIALS, { email, name, password });
});
exports.sendAdminCredentials = sendAdminCredentials;
const sendPartnerApprovalEmail = (email, name, resetLink) => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, email_queue_1.addEmailJob)(email_enum_1.EMAIL_WORKER.SEND_PARTNER_APPROVAL, { email, name, resetLink });
});
exports.sendPartnerApprovalEmail = sendPartnerApprovalEmail;
const sendPartnerRejectionEmail = (email, name) => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, email_queue_1.addEmailJob)(email_enum_1.EMAIL_WORKER.SEND_PARTNER_REJECTION, { email, name });
});
exports.sendPartnerRejectionEmail = sendPartnerRejectionEmail;
const sendForgotPasswordEmail = (email, name, resetLink) => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, email_queue_1.addEmailJob)(email_enum_1.EMAIL_WORKER.SEND_FORGOT_PASSWORD, { email, name, resetLink });
});
exports.sendForgotPasswordEmail = sendForgotPasswordEmail;
const sendBookingConfirmationEmail = (email, name, bookingId, serviceName, slot, amount) => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, email_queue_1.addEmailJob)(email_enum_1.EMAIL_WORKER.SEND_BOOKING_CONFIRMATION, { email, name, bookingId, serviceName, slot, amount });
});
