...
const landingHomeCache = (ttlSeconds) => {
    return (req, res, next) => {
        ...
        return (0, redisCache_1.createRedisCache)({
            ttlSeconds,
            keyPrefix: `${exports.LANDING_HOME_CACHE_GROUP}:${routePath}`,
        })(req, res, next);
    };
};
...
const clearLandingHomeCache = () => __awaiter(void 0, void 0, void 0, function* () {
    logger_1.default.info("Clearing landing home cache...");
    yield (0, redisCache_1.clearRedisCache)(exports.LANDING_HOME_CACHE_GROUP);
});
