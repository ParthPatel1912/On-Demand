...
exports.parseDbTimestampAsUTC = exports.getOtpExpiry = exports.generateOtp = void 0;
/**
 ...
 */
const parseDbTimestampAsUTC = (value) => {
    if (!value)
        return NaN;
    if (value instanceof Date) {
        ...
        return Date.parse(`${year}-${month}-${day}T${hours}:${minutes}:${seconds}.${milliseconds}Z`);
    }
    return Date.parse(value.replace(" ", "T") + "Z");
};
exports.parseDbTimestampAsUTC = parseDbTimestampAsUTC;
