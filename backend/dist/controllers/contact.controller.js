...
const getContacts = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield ContactService.getContacts({
        ...
        return (0, response_util_1.sendResponse)(res, Object.assign({}, result));
    }
    catch (error) {
...
const createContact = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        logger_1.default.info("Create Contact request");
        const { firstName, lastName, email, mobile, description } = req.body;
        const name = `${firstName || ""} ${lastName || ""}`.trim();
        const data = yield ContactService.createContact(String(name || ""), String(email || "").trim(), String(mobile || "").trim(), String(description || "").trim());
        return (0, response_util_1.sendResponse)(res, messages_1.MESSAGES.CONTACT.CREATED, data, enums_1.STATUS_CODE.CREATED);
    }
    catch (error) {
        logger_1.default.error((0, common_utils_1.getErrorMessage)(error));
        next(error);
