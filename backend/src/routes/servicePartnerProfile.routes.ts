...
/**
 * tags:
 *   name: Service Partner Profile
 *   description: Manage logged-in service partner profile (view & update)
 */

/**
 * /api/service-partner/profile:
 * summary: Get profile
 */
router.get(
  "/profile",
...
/**
 * /api/service-partner/update-profile:
 * summary: Update service partner profile
