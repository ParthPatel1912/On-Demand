...
const drawHomeCareLogoFallback = (
...
export const generateInvoicePDF = (data: InvoiceData, stream: Stream): void => {
  ...
  doc
    ...
    .font("Helvetica")
    .text(
      "This is a computer-generated invoice and does not require a signature. For any queries, please contact support@homecare.com",
      50,
      footerTop + 30,
