...
export const sendAdminCredentials = async (
  ...
  await addEmailJob(EMAIL_WORKER.SEND_ADMIN_CREDENTIALS, { email, name, password });
};
...
export const sendPartnerApprovalEmail = async (
  ...
  await addEmailJob(EMAIL_WORKER.SEND_PARTNER_APPROVAL, { email, name, resetLink });
};
...
export const sendForgotPasswordEmail = async (
  ...
  await addEmailJob(EMAIL_WORKER.SEND_FORGOT_PASSWORD, { email, name, resetLink });
};
...
export const sendBookingConfirmationEmail = async (
  ...
  await addEmailJob(EMAIL_WORKER.SEND_BOOKING_CONFIRMATION, { email, name, bookingId, serviceName, slot, amount });
};
